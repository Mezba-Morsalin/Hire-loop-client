...
useEffect(() => {
  ...
  recruiterId: company.recruiterId,
      ...
      const res = await fetch(
        `${process.env.NEXT_PUBLIC_SERVER_URL}/api/companies/${company._id}`,
        {
          method: "PATCH",
          headers: {
    ...
    return (
        <div>
            <Modal>
       <Button className='flex gap-3 border border-gray-300' variant='ghost'><CiEdit /> Edit Company</Button>
      <Modal.Backdrop>
    ...
    overflow-x-hidden
    rounded-2xl
    border border-zinc-800 editFormBg text-white
              ">
            <Modal.CloseTrigger />
            <Modal.Body className="p-6 ">
              <Surface variant="default">
                <form className='editFormBg' onSubmit={handleSubmit}>
...
>
  ...
  className="flex-1 bg-[#171717] px-4 py-3 text-white outline-none"
/>
                                    </div>
                                  </div>
